...
import { _PiezaCuadrado } from "../src/PieceSquare";

describe("_PiezaCuadrado", () => {

  test("se crea con posición inicial y forma cuadrado", () => {
    const pieza = new _PiezaCuadrado();
  ...
  test("se mueve correctamente", () => {
    const pieza = new _PiezaCuadrado(5, 5);
