...
import { _PiezaStick } from "../src/PieceStick";

describe("_PiezaStick", () => {

  test("se crea con posición inicial y forma Stick", () => {
    const pieza = new _PiezaStick();
  ...
  test("se mueve correctamente", () => {
    const pieza = new _PiezaStick(5, 5);
